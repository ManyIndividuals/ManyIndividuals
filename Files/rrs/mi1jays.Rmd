...
![](mi1jays_spp_Fig2.png){width=100%}
...
```{r plotjayflexbefore, echo=FALSE}
dflex.o <- read.csv(url("https://raw.githubusercontent.com/ManyIndividuals/ManyIndividuals/refs/heads/main/Files/rrs/mi1_jays_flexdata.csv"), 
                  header=T, sep=",", stringsAsFactors=F)
...
```{r plotfor-habitatuse, echo=FALSE}
...
```{r unregistered analysis plots, echo=FALSE}
...
```
![](mi1_jays_Figure5.png){width=100%}
...
Run the code to determine whether there were differences between the before and after conditions in the number of food types taken. 
