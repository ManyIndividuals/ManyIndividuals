...
y is the response variable (duration at cafes and dumpsters when food was present / total duration at cafes and dumpsters). There will be one intercept, $\alpha$, and one slope $\beta$ per individual, which will be estimated for the two times, B (before and after manipulation). A normal distribution was used because the response variable is a sum with an expected normal distribution  [@mcelreath2020statistical]. The Bayesian model was developed using @mcelreath2020statistical as a guide.
