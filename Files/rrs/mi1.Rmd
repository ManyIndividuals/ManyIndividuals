...
# Set the means you want to compare. To get a certain mean change in number of microhabitats between before and after, set the multiplier in the changenumber mean: a large multiplier means a large change
...
meanchangenumber2<-0.5 # individuals will on average take 4 more foods after the experiment ((13-numberbefore)*0.5  = 4)
meanchangenumber3<-0.333 #individuals will on average take 3 more foods after the experiment ((13-numberbefore)*0.33  = 3)
meanchangenumber4<-0.17 # individuals will on average take 2 more foods after the experiment ((13-numberbefore)*0.17  = 2)
meanchangenumber5<-0.08 # individuals will on average take 1 more food after the experiment ((13-numberbefore)*0.08 = 1)
meanchangenumber6<-0 # individuals will on average take 0 more foods after the experiment ((13-numberbefore)*0  = 0)
changenumbervariants<-c(meanchangenumber1,meanchangenumber2,meanchangenumber3,meanchangenumber4,meanchangenumber5,meanchangenumber6) #for false negatives
#changenumbervariants<-c(0) #for false positives
#changenumbervariants<-c(meanchangeprop6) #for showing differences
