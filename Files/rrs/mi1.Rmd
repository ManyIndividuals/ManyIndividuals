...
# Set the means you want to compare. To get a certain mean change in number of microhabitats between before and after, set the subtractor in the changenumber mean (as above): a small subtractor means a large change
meanchangenumber1<-1 #individuals will on average take 5 more foods after the experiment ((13-numberbefore)*1 = push everyone to 13 - 1.5  = 5)
meanchangenumber2<-0.5 # individuals will on average take 4 more foods after the experiment (13-6.5 = 6.5 - 2.5  = 4)
meanchangenumber3<-0.333 #individuals will on average take 3 more foods after the experiment (13-6.5 = 6.5 - 3.5  = 3)
meanchangenumber4<-0.17 # individuals will on average take 2 more foods after the experiment (13-6.5 = 6.5 - 4.5  = 2)
meanchangenumber5<-0.08 # individuals will on average take 1 more food after the experiment (13-6.5 = 6.5 - 5.5  = 1)
meanchangenumber6<-0 # individuals will on average take 0 more foods after the experiment (13-6.5 = 6.5 - 6.5  = 0)
changenumbervariants<-c(meanchangenumber1,meanchangenumber2,meanchangenumber3,meanchangenumber4,meanchangenumber5,meanchangenumber6) #for false negatives
#changenumbervariants<-c(0) #for false positives
#changenumbervariants<-c(meanchangeprop6) #for showing differences
...
for (samplesize in 1:length(samplesizes)) {
        ...
        changenumber <- rnorm(N_ind, mean=(13-numberbefore)*(currentchangenumber),d=2) #change this SD to explore the boundaries of individual variation in their response (in terms of the success measure) to the flexibility manipulation. We explored SD=1 and SD=2
...
mtext("Sample size",side=3,line=-0.7,at=4.9)
mtext("B. SD=1",side=3,line=1,at=0.5,cex=1.3)
mtext("Mean change in number of foods taken before vs after",side=1,line=3, cex=1)
par(op)
