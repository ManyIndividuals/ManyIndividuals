...
**Background:** Jay species in the genus *Aphelocoma* exhibit a diversity of social systems and success in colonizing suburban and urban areas. California scrub-jays (*A. californica*, hereafter "CASJ"), a singular, monogamous breeder, are increasing in abundance, expanding the range size and highly successful in natural, suburban, and urban areas [@blair1996land; @curry2017california]. CASJ forage primarily on mast (acorns, hazelnuts, etc.) that they cache throughout their territory to eat all year. But they are also opportunistic omnivores and specifically need high-fat and high-protein arthropods to feed to nestlings and fledglings [@curry2017california]. Nesting and foraging substrate can be drastically different in human modified environments compared to natural areas [@tuomainen2011behavioural], but it is unknown whether suburban and urban jays persist through behavioral adaptations. To test for selection on behavioral flexibility in human modified environments, we will compare behavioral flexibility, foraging and nest success of jays in suburban areas to those in natural areas. We will experimentally manipulate the flexibility of jays in human modified environments to determine whether manipulated jays are subsequently more successful than control jays. 

In contrast, the Florida scrub-jay (*A. coerulescens*; hereafter "FLSJ") is a threatened species endemic and range-restricted to central Florida. FLSJ have colonized suburban habitats, however suburban populations of FLSJ steadily decline after colonization events [Bowman pers. comm.]. This is potentially due to higher rates of brood reduction through nestling starvation [@shawkey2004why] and the lack of nutritionally complete prey items [@shawkey2004why] in suburban habitats. It is possible that behavioral flexibility in foraging breadth underlies the persistence of CASJ in suburban areas relative to FLSJ. We aim to compare behavioral flexibility of these two species to determine whether this trait is related to the greater persistence of CASJ in human-dominated areas and we will test whether manipulating flexibility of FLSJ will increase the foraging breadth and reproductive success of FLSJ in human modified environments.


**Q1: Do CASJ and FLSJ in human modified and natural areas differ in baseline behavioral flexibility?**
...
**Q2: How does baseline behavioral flexibility compare between CASJ and FLSJ?**

 - **Prediction 2.1:** CASJ are *more* flexible than FLSJ
 - **Prediction 2.2:** CASJ are *less* flexible than FLSJ
 - **Prediction 2.3:** CASJ and FLSJ are *equally* flexible
