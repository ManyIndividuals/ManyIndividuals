...
**This registered report has been pre-study peer reviewed and received an In Principle Acceptance by:**

Chris Chambers (2022) . *Peer Community in Registered Reports*, . [](). Reviewers:  Gloriana Chaverri, Vedrana Šlipogor, and Alizée Vernouillet

![](logoPCIRR.png){width=50%}

**Cite as:** Logan CJ, Shaw R,  Lukas D, McCune KB. 2022. **[How to succeed in human modified environments](http://corinalogan.com/ManyIndividuals/mi1.html)** (http://corinalogan.com/ManyIndividuals/mi1.html) In principle acceptance by *PCI Registered Reports* of the version on 25 Aug 2022 []().
