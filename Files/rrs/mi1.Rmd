...
**Social learning spread would decrease the number of inds you have to train & discuss how intersects with flex: observers learn how to solve what they see (or maybe learning to use social info), but not teaching flex, add explanatory variable to soc learn model: condition (control or manipulated) to see if we wrong that they don’t learn flex (horiz and/or vert transmission)**
