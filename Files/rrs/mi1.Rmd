...
# Reset your working directory to what it was before we ran the model. COPY AND PASTE THIS INTO THE CONSOLE!
...
#model output: pay attention to the output for b. If positive, this shows that there is a positive correlation between the proportion of time spent in the presence of a reward after the manipulation and an individual's phi.
precis(m1,depth=2)
```
