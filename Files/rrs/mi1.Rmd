...
Number of different food types taken per individual ~ Condition + (Condition | ID)
...
#before
numberbefore <- round(rnorm(N_ind,mean=6.5,sd=1),2) #number of foods taken, 2 means 2 decimal points
...
#after
numberafter <- round(numberbefore+rnorm(N_ind,mean=changenumber,sd=1),2)
...
#check the plot to see whether individuals are increasing their numbers = several points are below the 1:1 line
plot(numberbefore,numberafter)
abline(0,1)
