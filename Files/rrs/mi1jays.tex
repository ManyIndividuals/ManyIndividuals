...
success in human modified environments (\textbf{Logan2025behavioral?}).
What is still unknown, is whether this manipulation can also influence
the success of a species that is threatened or endangered with
extinction. That is the research we focused on here.
...
\section{Population-specific background and tailored research
...
of jays in suburban and natural environments. Although we do not
quantify social diffusion of the manipulated behaviors here, previous
research demonstrates that this species has the capacity to socially
learn foraging information discovered by others and so manipulating the
flexibility of a subset of individuals has the potential to affect the
population (Midford et al., 2000).
...
\subsubsection{Baseline behavioral
flexibility}\label{baseline-behavioral-flexibility}
...
\subsubsection{Flexibility manipulation (Design 2 from the registered
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mi1_jays_Table2.png}
...
\pandocbounded{\includegraphics[keepaspectratio]{mi1jays_files/figure-latex/plotjayflexbefore-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{mi1jays_files/figure-latex/plotfor-habitatuse-1.pdf}}
...
{[}1{]} ``powerline'' ``oak'' ``greenbriar''\\
{[}4{]} ``snag'' ``muscadine'' ``sand''\\
{[}7{]} ``pine'' ``roof'' ``mango tree''\\
{[}10{]} ``silk bay'' ``rusty lyonia'' ``fence post''\\
{[}13{]} ``grass'' ``palmetto'' ``fetterbush''\\
{[}16{]} ``fence'' ``tarflower'' ``madrona''\\
{[}19{]} ``avocado tree'' ``bucket'' ``sand rosemary''\\
{[}22{]} ``hickory'' ``light pole'' ``pavement''\\
{[}25{]} ``sand heath'' ``tallow wood'' ``wax myrtle''\\
{[}28{]} ``holly'' ``inkberry'' ``unk tree''\\
{[}31{]} ``scrub blueberry'' ``groundseltree'' ``antenna''\\
{[}34{]} ``powerline pole'' ``mangrove tree'' ``gerberia''\\
{[}37{]} ``unk'' ``sign'' ``manzanita''\\
{[}40{]} ``loquat tree'' ``chicken coop'' ``starfruit tree''\\
{[}43{]} ``chicken fence'' ``banana tree'' ``brazilian peppertree''
{[}46{]} ``maple'' ``cocoplum'' ``street sign''\\
{[}49{]} ``unk shrub'' ``plastic post'' ``palm''\\
{[}52{]} ``coco plum'' ``mimosa tree'' ``guanacaste''\\
{[}55{]} ``gum bumelia tree'' ``muscadine vine'' ``maple tree''\\
{[}58{]} ``tarp'' ``magnolia'' ``cement''\\
{[}61{]} ``chinese tallow'' ``norfolk island pine'' ``brazillian
peppertree'' {[}64{]} ``none'' ``power line'' ``impervious surface''\\
{[}67{]} ``loquat'' ``dirt'' ``non-native bush''\\
{[}70{]} ``wooden carport'' ``brick'' ``bayberry''\\
\pandocbounded{\includegraphics[keepaspectratio]{mi1jays_files/figure-latex/unregistered analysis plots-1.pdf}}
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{mi1_jays_Figure5.png}
